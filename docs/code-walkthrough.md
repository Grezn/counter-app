...
- 系統 / 設備
- 事件主旨
- 報修表單資訊，例如經銷商、問題描述、產品、合約、序號、服務類型、後續處理方式
- 影響範圍
- 已通知對象
- 下一步
- 處理紀錄
...
「複製交班摘要」會把目前表單和 checklist 組成文字，方便貼到 Jira、交班小卡或訊息。

報修表單資訊是參考「第一線客戶資訊表」做的。這些欄位仍然只存在你的瀏覽器，不會自動送去 Microsoft Forms；它的用途是讓你值班時先整理資料，最後複製交班摘要或再貼到正式表單。
